...
<body>
		...
		<div class="container d-flex flex-wrap justify-content-center">
			<ul class="nav me-auto">
				...
				<li class="nav-item"><a href="volunteer.jsp"
					class="nav-link link-dark px-2 active text-white mx-5">봉사활동 찾기</a></li>
	...
	<!-- main -->
	<form method="post" action="v_process.jsp">
				...
				<div class="col">
					...
					<div class="form-check">
						<input class="form-check-input" type="checkbox" checked> <label
							class="form-check-label">성인</label>
					</div>
					<div class="form-check">
						<input class="form-check-input" type="checkbox"> <label
							class="form-check-label">청소년</label>
					</div>
				</div>
				<div class="col">
					<h2>일자</h2>
					<hr>
					<div>
						<label>시작일 </label> <input type="text" id="datePicker">
					</div>
					<div>
						<label>종료일 </label> <input type="text" id="datePicker2">
					</div>
				</div>
			</div><br><br>
