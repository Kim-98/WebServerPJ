...
<style>
	...
	input { width: 70%; }
	textarea { width: 70%; }
	#head { background-color: beige; font-weight:bold; }
</style>
</head>
<body>
<!-- navigator -->
...
<!-- table -->
	...
	<div class="container-fluid px-5 my-5 w-80" >
		<form method="post" action="commu_process.jsp">
			<table class="table text-center">
				<tr>
					<td id="head">제목</td>
					<td><input type="text" name="subject" class="form-control" placeholder="글 제목 입력" />
				</tr>
				<tr>
					<td id="head">닉네임</td>
					<td><input type="text" name="name" class="form-control" placeholder="닉네임 입력" />
				</tr>
				<tr>
					<td id="head">내용</td>
					<td><textarea rows="10" name="content" class="form-control" placeholder="글 내용 입력"></textarea>
				</tr>
			</table>
